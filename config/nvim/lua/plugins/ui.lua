return {
    ...
    },
    {
        ...
        config = function()
            ...
            local function lsp_search_smart()
                if vim.fn.mode() == 'v' or vim.fn.mode() == 'V' then
                    ...
                    builtin.lsp_document_symbols({ default_text = selection })
                else
            ...
            vim.keymap.set('n', '<C-s>', lsp_search_smart, {})
